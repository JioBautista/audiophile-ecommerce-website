...
function Footer() {
  return (
    <Container
      styles={
        "px-5 py-10 bg-black text-white text-center space-y-10 md:grid md:grid-cols-2 md:grid-rows-4 md:justify-items-start md:items-center md:space-y-0 md:text-start"
      }
    >
      <div>
        <h3 className="text-3xl font-bold">audiophile</h3>
      </div>
      <div className="items-center justify-center space-y-5 md:col-start-1 md:col-end-3 md:flex md:gap-5 md:space-y-0">
      ...
      <div className="md:col-start-1 md:col-end-3 md:row-start-3">
        <p className="text-gray-500">
          Audiophile is an all in one stop to fulfill your audion needs. We're a
          small team of music lovers and sound specialists who are devoted to
          help you get the most out of a personal audio. Come and visit our demo
      ...
      <div className="space-x-5 md:col-start-2 md:row-start-4 md:justify-self-end">
        <img
